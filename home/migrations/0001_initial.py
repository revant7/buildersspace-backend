...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Attendee',
            fields=[
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='attendee_profile', serialize=False, to='home.user')),
            ],
        ),
        migrations.CreateModel(
            name='Participant',
            fields=[
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='participant_profile', serialize=False, to='home.user')),
        ...
        migrations.CreateModel(
            name='SocialLinks',
            fields=[
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='social_links', serialize=False, to='home.user')),
        ...
        migrations.CreateModel(
            name='LikeCount',
            fields=[
                ('project', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='like_count', serialize=False, to='home.project')),
        ...
        migrations.CreateModel(
            name='VoteCount',
            fields=[
                ('project', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='vote_count', serialize=False, to='home.project')),
                ('count', models.IntegerField(default=0)),
            ],
            options={
